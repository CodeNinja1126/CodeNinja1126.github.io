...
def get_binary__number(decimal_number : int):
...
<ipython-input-12-288317decb61> in <module>
      3     return bin(decimal_number)
      4 
----> 5 print(get_binary_number(10.0))

NameError: name 'get_binary_number' is not defined
'''
```
...
![6.png](/image/2021-01-22/6.png)

![7.png](/image/2021-01-22/7.png)
...
![8.png](/image/2021-01-22/8.png)

![9.png](/image/2021-01-22/9.png)
...
![10.png](/image/2021-01-22/10.png)
